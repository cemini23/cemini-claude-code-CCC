---
title: "AskChem — claim-centered literature MCP"
type: entity
tags: [entity, tool, mcp, claims, k233]
keywords: [AskChem, MIT, askchem.org]
related:
...
|----------|------|------|---------|
| `bingyan4science/askchem` | MIT | ~9.3MB | **GO** REFERENCE |
| askchem.org | SaaS | — | **WATCH** / chemistry OOD |
