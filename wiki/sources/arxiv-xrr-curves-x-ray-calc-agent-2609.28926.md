---
title: "Teaching an LLM agent to fit XRR curves with X-Ray Calc 3 (CCC K391)"
type: source
tags: [source, arxiv, k391]
keywords: [2609.28926, k391]
related:
...
**OOD** materials/instruments — LLM agent fits XRR curves with X-Ray Calc 3 (pairs K342 hierarchical SPM automation stub). **Source only** — no CCC concept page. No clone. Runtime **`wont_wire`**.
