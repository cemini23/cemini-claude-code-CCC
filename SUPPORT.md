...
Voluntary tips fund wikis, OSS tooling, and public research. **Donation-only addresses** — not trading or production wallets. **X Money** is fiat / US (rolling out): if Request is not on your account, use a chain address below.
