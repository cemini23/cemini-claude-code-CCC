...
CLONE_ENTITY_ALIASES = {
    "ccc": {
        ...
        "asm": "entities/tools/asm-adopt-orphan.md",
        "biosecbench-surveillance": "entities/tools/biosecbench-surveillance.md",
        "DataFlow": "entities/tools/dataflow-opendcai.md",
        "DynAMO": "entities/tools/dynamo-orchestration.md",
        "tars": "entities/tools/tars-vscode.md",
        "claude-plugin-marketplace": "entities/tools/jezweb-claude-skills.md",
        "mattpocock-skills": "entities/tools/mattpocock-skills.md",
        "Awesome-Agent-Engineering": "entities/tools/awesome-agent-engineering.md",
        "Bayesian-Agent": "entities/tools/bayesian-agent.md",
        "LightMem2": "entities/tools/lightmem2.md",
        "SearchOS": "entities/tools/searchos.md",
        "flowforge-skill": "entities/tools/flowforge-skill.md",
        "user-as-code": "entities/tools/user-as-code.md",
        "PaperClaw": "entities/tools/paperclaw.md",
        "MemProbe": "entities/tools/memprobe.md",
        "fara": "entities/tools/fara.md",
        "omnifs": "entities/tools/omnifs.md",
        "nuance-mcp": "entities/tools/nuance-mcp.md",
        "agents4geos": "entities/tools/agents4geos.md",
        "iterasim-rag-public": "entities/tools/iterasim-rag-public.md",
        "sancho-acp-clients": "entities/tools/sancho-acp-clients.md",
        "satellite-mission-compiler": "entities/tools/satellite-mission-compiler.md",
        "agentgateway": "entities/tools/agentgateway.md",
    },
    "osint": {
        "agentradio": "entities/tools/agentradio.md",
        # Avoid fuzzy false positives (e.g. "ecc" ⊂ "impeccable")
        "ecc": "entities/tools/ecc.md",
        "yorkeccak-history": "entities/tools/yorkeccak-history.md",
        "impeccable": "entities/tools/impeccable.md",
        "opencli": "entities/tools/qiaomu-opencli-skills.md",
        "codex-security": "entities/tools/openai-codex-security.md",
        "openwork": "entities/tools/different-ai-openwork.md",
        "daisyui-npm": "entities/tools/daisyui.md",
        "aidlc": "entities/tools/aidlc-it-department-manager.md",
        "claude_immigration_attorney": "entities/tools/claude-immigration-attorney.md",
